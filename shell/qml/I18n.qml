...
Item {
  ...
  readonly property var en: ({
    ...
    "input.placeholderStreamingQa": "Answering… (send starts a fresh Q&A)",
    ...
    "chat.emptyHint.qa": "Q&A mode · one question, one answer, nothing kept\nType `/cmd` to switch to Command mode",
    ...
    "chat.modeSwitchedQa": "Switched to Q&A mode (one Q&A, nothing kept)",
